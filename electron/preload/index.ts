...
const api = {
  ...
  addNewAccount: () => ipcRenderer.invoke('add-new-account'),
  loginAccount: (accountNumber : number) => ipcRenderer.invoke('login-account', accountNumber),
  updateAccount: (accountNumber : number, newData : any) => ipcRenderer.invoke('update-account', accountNumber, newData),
  removeAccount: (accountNumber : number) => ipcRenderer.invoke('remove-account', accountNumber),
